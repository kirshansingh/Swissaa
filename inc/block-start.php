...
/**
  ...
  */
  ...
  if(isset($is_preview) && $is_preview == true) { $block_disabled = false; } 
  ...
  <?php if((!$block_disabled)): ?>
    <<?php echo $wraperTag; ?> id="<?php echo esc_attr($id); ?>" class="<?php echo $blockRootClasses; generateElementClasses('block', $is_preview); echo esc_attr($className); ?>" <?php generateElementTags('block', $is_preview); ?>>
  <?php endif; ?>
